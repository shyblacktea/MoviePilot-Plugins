...
from app.sdk.media import MediaInfo, TorrentInfo
...
class MonkeyPatchManager:
    ...
    def __init__(self):
        ...
        self.CACHE_REGION = "curetmdbanimeshy:torrent_pubdate"
    ...
    def patch_httpx_transport(self):
        ...
        """
        import app.adapters.network.http as http_utils_module
