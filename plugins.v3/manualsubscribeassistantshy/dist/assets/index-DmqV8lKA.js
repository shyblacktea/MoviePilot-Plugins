...
import Page from './__federation_expose_Page-CnUJhx8n.js';
import ConfigComponent from './__federation_expose_Config-C03414ex.js';
import DashboardComponent from './__federation_expose_Dashboard-eEqniloa.js';
...
function createMockApi() {
  return {
    ...
    post(url, body) {
      ...
      if (url.endsWith("/candidates/batch-delete")) {
      ...
      if (url.endsWith("/candidates/subscribe")) {
        ...
        default: _withCtx(() => [
          _createVNode$2h(_component_v_app_bar_title, { class: "text-body-1 font-weight-bold" }, {
            default: _withCtx(() => _cache[7] || (_cache[7] = [
              _createTextVNode$7("手动订阅助手 · 组件预览")
            ])),
            _: 1
          })
        ]),
...
const App = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-fa59d957"]]);
