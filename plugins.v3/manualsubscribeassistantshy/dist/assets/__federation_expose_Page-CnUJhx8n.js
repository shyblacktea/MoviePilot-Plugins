...
const MSG = {
  'zh-CN': {
    ...
    kType: '类型', kSource: '来源', kTime: '订阅时间', kYear: '发行年份', source: '手动订阅助手',
  ...
  'zh-TW': {
    ...
    kType: '類型', kSource: '來源', kTime: '訂閱時間', kYear: '發行年份', source: '手動訂閱助手',
...
const SubscribeView = /*#__PURE__*/_export_sfc(_sfc_main$1, [['__scopeId',"data-v-cd7f30cd"]]);
            ...
            _createElementVNode("div", _hoisted_10, [
              (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(statCards.value, (s) => {
                return (_openBlock(), _createElementBlock("button", {
                  key: s.key,
                  type: "button",
                  class: _normalizeClass(['asa-stat', `asa-stat--${s.color}`, { 'asa-stat--active': filters.status === s.key }]),
...
const Page = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-d8408826"]]);
