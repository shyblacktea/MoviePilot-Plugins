...
const _hoisted_48 = { class: "sp-pane" };
const _hoisted_49 = { class: "d-flex align-center mb-2" };
const _hoisted_50 = { class: "sp-config-section" };
const _hoisted_51 = { class: "sp-field-rows" };
const _hoisted_52 = { class: "sp-field-info" };
const _hoisted_53 = { class: "sp-field-label" };
const _hoisted_54 = { class: "sp-field-control sp-ctl-select" };
const _hoisted_55 = { class: "sp-config-section mt-3" };
const _hoisted_56 = { class: "sp-field-rows" };
const _hoisted_57 = { class: "sp-field-row" };
const _hoisted_58 = { class: "sp-field-control sp-ctl-select" };
const _hoisted_59 = { class: "sp-field-info" };
const _hoisted_60 = { class: "sp-field-control sp-ctl-select" };
const _hoisted_61 = { class: "sp-field-actions" };
const _hoisted_62 = { class: "d-flex align-center mt-2" };
const _hoisted_63 = {
  key: 0,
  class: "text-caption text-medium-emphasis ml-3"
};
const _hoisted_64 = { class: "sp-section-title" };
const _hoisted_65 = { class: "sp-field-rows" };
const _hoisted_66 = { class: "sp-field-info" };
const _hoisted_67 = { class: "sp-field-label" };
const _hoisted_68 = {
  key: 0,
  class: "sp-field-hint"
};
...
const _hoisted_70 = { class: "sp-dashboard-section" };
const _hoisted_71 = { class: "sp-dashboard-title" };
const _hoisted_72 = { class: "sp-dashboard-row" };
const _hoisted_73 = { class: "sp-dashboard-row" };
const _hoisted_74 = { class: "sp-dashboard-row" };
const _hoisted_75 = { class: "sp-dashboard-row" };
const _hoisted_76 = { class: "sp-dashboard-section" };
const _hoisted_77 = { class: "sp-dashboard-title" };
const _hoisted_78 = { class: "sp-dashboard-row" };
...
return (_ctx, _cache) => {
  ...
  return (_openBlock(), _createElementBlock("div", _hoisted_1, [
        ...
        _createElementVNode("div", _hoisted_6, [
          ...
          _createElementVNode("section", _hoisted_8, [
            ...
            _createElementVNode("div", _hoisted_13, [
              _createElementVNode("div", _hoisted_14, [
                _withDirectives(_createElementVNode("div", _hoisted_15, [
                  _createElementVNode("div", _hoisted_16, [
                    _cache[21] || (_cache[21] = _createElementVNode("div", { class: "sp-section-title mb-0" }, "运行概览", -1)),
                  ...
                  _createElementVNode("div", _hoisted_17, [
                    _createElementVNode("div", _hoisted_18, [
                      _createElementVNode("div", _hoisted_19, [
                        ...
                        _cache[22] || (_cache[22] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "最近扫描", -1))
                      ]),
                    ...
                    _createElementVNode("div", _hoisted_21, [
                      _createElementVNode("div", _hoisted_22, [
                        ...
                        _cache[23] || (_cache[23] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "待处理", -1))
                      ]),
                    ...
                    _createElementVNode("div", _hoisted_24, [
                      _createElementVNode("div", _hoisted_25, [
                        ...
                        _cache[24] || (_cache[24] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "可下载", -1))
                      ]),
                    ...
                    _createElementVNode("div", _hoisted_27, [
                      _createElementVNode("div", _hoisted_28, [
                        ...
                        _cache[25] || (_cache[25] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "规则修改", -1))
                      ]),
                ...
                _withDirectives(_createElementVNode("div", _hoisted_38, [
                  _createElementVNode("div", _hoisted_39, [
                    _cache[28] || (_cache[28] = _createElementVNode("div", { class: "sp-section-title mb-0" }, "自定义识别词", -1)),
                    _createVNode(_component_VSpacer),
                    _createVNode(_component_VChip, {
                      size: "small",
                      variant: "tonal"
                ...
                _withDirectives(_createElementVNode("div", _hoisted_45, [
                  _createElementVNode("div", _hoisted_46, [
                    _cache[32] || (_cache[32] = _createElementVNode("div", { class: "sp-section-title mb-0" }, "规则修改记录", -1)),
                    _createVNode(_component_VSpacer),
                ...
                _withDirectives(_createElementVNode("div", _hoisted_48, [
                  _createElementVNode("div", _hoisted_49, [
                    _cache[34] || (_cache[34] = _createElementVNode("div", { class: "sp-section-title mb-0" }, "F4通知目标面板", -1)),
                    _createVNode(_component_VSpacer),
                    _createVNode(_component_VBtn, {
                      color: "primary",
                      "prepend-icon": "mdi-content-save",
                  ...
                  (f4Error.value)
                    ? (_openBlock(), _createBlock(_component_VAlert, {
                        ...
                        class: "mb-3 text-caption",
                        closable: "",
                        "onClick:close": _cache[10] || (_cache[10] = $event => (f4Error.value = ''))
                      }, {
                        default: _withCtx(() => [
                  ...
                  (f4Hint.value)
                    ? (_openBlock(), _createBlock(_component_VAlert, {
                        ...
                        class: "mb-3 text-caption",
                        closable: "",
                        "onClick:close": _cache[11] || (_cache[11] = $event => (f4Hint.value = ''))
                      }, {
                        default: _withCtx(() => [
                  ...
                  _createElementVNode("section", _hoisted_50, [
                    _cache[36] || (_cache[36] = _createElementVNode("div", { class: "sp-section-title" }, "1. 系统通知目标（资源入库 / 资源下载 / 订阅）", -1)),
                      ...
                      (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(f4Rows.value, (row) => {
                        return (_openBlock(), _createElementBlock("div", {
                          ...
                          _createElementVNode("div", _hoisted_52, [
                            _createElementVNode("div", _hoisted_53, _toDisplayString(row.label), 1),
                            _cache[35] || (_cache[35] = _createElementVNode("div", { class: "sp-field-hint" }, "控制 MoviePilot 该类型系统通知的投递目标；发群组表示按各通知渠道开关发送到群。", -1))
                          ]),
                  ...
                  _createElementVNode("section", _hoisted_55, [
                    _cache[40] || (_cache[40] = _createElementVNode("div", { class: "sp-section-title" }, "2. 订阅用户通知映射（SubscribePlus 诊断通知）", -1)),
                    _createElementVNode("div", _hoisted_56, [
                      _createElementVNode("div", _hoisted_57, [
                        _cache[37] || (_cache[37] = _createElementVNode("div", { class: "sp-field-info" }, [
                        ...
                        _createElementVNode("div", _hoisted_58, [
                          _createVNode(_component_VSelect, {
                            ...
                            "onUpdate:modelValue": _cache[12] || (_cache[12] = $event => ((defaultNotifyTargets).value = $event)),
                    ...
                    _createElementVNode("div", _hoisted_62, [
                      ...
                      (!availableNotifyUsernames.value.length && notifyUsernameOptions.value.length)
                        ? (_openBlock(), _createElementBlock("div", _hoisted_63, " 所有订阅用户均已配置 "))
                        : _createCommentVNode("", true)
                    ])
                  ])
                ], 512), [
                  ...
                  return _withDirectives(_createElementVNode("div", {
                    ...
                    (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(sectionsOf(groupKey), (section, sIdx) => {
                      return (_openBlock(), _createElementBlock("section", {
                        ...
                        _createElementVNode("div", _hoisted_64, _toDisplayString((sIdx + 1) + '. ' + section.title), 1),
                          ...
                          (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(section.fields, (field) => {
                            return (_openBlock(), _createElementBlock("div", {
                              ...
                              _createElementVNode("div", _hoisted_66, [
                                _createElementVNode("div", _hoisted_67, _toDisplayString(field.label), 1),
                                (field.hint)
                                  ? (_openBlock(), _createElementBlock("div", _hoisted_68, _toDisplayString(field.hint), 1))
                                  : _createCommentVNode("", true)
                              ]),
              ...
              _createElementVNode("aside", _hoisted_69, [
                _createElementVNode("section", _hoisted_70, [
                  ...
                  _createElementVNode("div", _hoisted_73, [
                    ...
                    _cache[43] || (_cache[43] = _createElementVNode("span", null, "超期检测", -1)),
                  ...
                  _createElementVNode("div", _hoisted_74, [
                    ...
                    _cache[44] || (_cache[44] = _createElementVNode("span", null, "通知方式", -1)),
                    _cache[45] || (_cache[45] = _createElementVNode("strong", null, "队列逐条", -1))
                  ]),
                  _createElementVNode("div", _hoisted_75, [
                    _createVNode(_component_VIcon, { icon: "mdi-database-clock-outline" }),
                    _cache[46] || (_cache[46] = _createElementVNode("span", null, "候选缓存", -1)),
                ...
                _createElementVNode("section", _hoisted_76, [
                  _createElementVNode("div", _hoisted_77, [
                    ...
                    _cache[47] || (_cache[47] = _createTextVNode("运行概况", -1))
                  ]),
                  _createElementVNode("div", _hoisted_78, [
                    _createVNode(_component_VIcon, { icon: "mdi-history" }),
                    _cache[48] || (_cache[48] = _createElementVNode("span", null, "最近扫描", -1)),
                  ...
                  _createElementVNode("div", _hoisted_79, [
                    ...
                    _cache[49] || (_cache[49] = _createElementVNode("span", null, "待处理", -1)),
                  ...
                  _createElementVNode("div", _hoisted_80, [
                    ...
                    _cache[50] || (_cache[50] = _createElementVNode("span", null, "候选资源", -1)),
                  ...
                  _createElementVNode("div", _hoisted_81, [
                    ...
                    _cache[51] || (_cache[51] = _createElementVNode("span", null, "已启用功能", -1)),
    ...
    _createVNode(_component_VBottomSheet, {
      ...
      "onUpdate:modelValue": _cache[13] || (_cache[13] = $event => ((mobileGroupSheet).value = $event))
    }, {
      default: _withCtx(() => [
        _createVNode(_component_VCard, {
          rounded: "t-xl",
    ...
    _createVNode(_component_VDialog, {
      ...
      "onUpdate:modelValue": _cache[15] || (_cache[15] = $event => ((previewDialog).value = $event)),
      "max-width": "720"
    }, {
      default: _withCtx(() => [
          ...
          default: _withCtx(() => [
              ...
              default: _withCtx(() => [
                ...
                (ruleSuggestions.value.length && !preview.value)
                  ? (_openBlock(), _createElementBlock("div", _hoisted_82, [
                      _cache[54] || (_cache[54] = _createElementVNode("div", { class: "text-caption text-medium-emphasis mb-2" }, "请选择要添加的官组、平台关键词或 PT 站点", -1)),
                ...
                (preview.value)
                  ? (_openBlock(), _createElementBlock("div", _hoisted_83, [
                      (preview.value.selected_text)
                        ? (_openBlock(), _createElementBlock("div", _hoisted_84, "已选择：" + _toDisplayString(preview.value.selected_text), 1))
                        : _createCommentVNode("", true),
            ...
            _createVNode(_component_VCardActions, null, {
              default: _withCtx(() => [
                ...
                _createVNode(_component_VBtn, {
                  variant: "text",
                  onClick: _cache[14] || (_cache[14] = $event => (previewDialog.value = false))
                }, {
    ...
    _createVNode(_component_VSnackbar, {
      ...
      "onUpdate:modelValue": _cache[16] || (_cache[16] = $event => ((saveSnackbar).value = $event)),
      color: "success",
      location: "top",
      timeout: 2200
    }, {
...
const Config = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-40fb6e59"]]);
