...
const _hoisted_1 = { class: "sp-page" };
const _hoisted_2 = { class: "sp-scroll" };
const _hoisted_3 = { class: "sp-stat-grid" };
const _hoisted_4 = { class: "sp-stat" };
const _hoisted_5 = { class: "d-flex align-center ga-2 mb-1" };
const _hoisted_6 = { class: "text-subtitle-2 font-weight-bold sp-stat-value" };
const _hoisted_7 = { class: "sp-stat" };
const _hoisted_8 = { class: "d-flex align-center ga-2 mb-1" };
const _hoisted_9 = { class: "text-subtitle-1 font-weight-bold" };
const _hoisted_10 = { class: "sp-stat" };
const _hoisted_11 = { class: "d-flex align-center ga-2 mb-1" };
const _hoisted_12 = { class: "text-subtitle-1 font-weight-bold" };
const _hoisted_13 = { class: "sp-stat" };
...
const _hoisted_19 = { class: "text-caption text-medium-emphasis mb-2" };
const _hoisted_20 = {
  key: 0,
  class: "sp-candidate-wrap mt-2"
};
const _hoisted_21 = { class: "sp-cand-site" };
const _hoisted_22 = { class: "sp-cand-title" };
const _hoisted_23 = { class: "sp-cand-seed" };
const _hoisted_24 = { class: "text-right sp-cand-act" };
const _hoisted_25 = {
  key: 1,
  class: "sp-suggestion"
};
  ...
  return (_openBlock(), _createElementBlock("div", _hoisted_1, [
    _createElementVNode("div", _hoisted_2, [
            ...
            default: _withCtx(() => [
              ...
              _createVNode(_component_VCardSubtitle, { class: "text-caption" }, {
                default: _withCtx(() => [...(_cache[12] || (_cache[12] = [
                  _createTextVNode("已播出未入库订阅的诊断与处理", -1)
                ]))]),
                _: 1
              })
            ]),
              ...
              _createElementVNode("div", _hoisted_3, [
                _createElementVNode("div", _hoisted_4, [
                  _createElementVNode("div", _hoisted_5, [
                    ...
                    _cache[13] || (_cache[13] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "最近扫描", -1))
                  ]),
                  _createElementVNode("div", _hoisted_6, _toDisplayString(status.value.last_scan || '-'), 1)
                ]),
                _createElementVNode("div", _hoisted_7, [
                  _createElementVNode("div", _hoisted_8, [
                    ...
                    _cache[14] || (_cache[14] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "待处理", -1))
                  ]),
                  _createElementVNode("div", _hoisted_9, _toDisplayString(items.value.length), 1)
                ]),
                _createElementVNode("div", _hoisted_10, [
                  _createElementVNode("div", _hoisted_11, [
                    ...
                    _cache[15] || (_cache[15] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "可下载", -1))
                  ]),
                  _createElementVNode("div", _hoisted_12, _toDisplayString(reasonCount.value.downloadable || 0), 1)
                ]),
                _createElementVNode("div", _hoisted_13, [
                  _createElementVNode("div", _hoisted_14, [
                    ...
                    _cache[16] || (_cache[16] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "规则修改", -1))
                  ]),
                  _createElementVNode("div", _hoisted_15, _toDisplayString(ruleRecords.value.length), 1)
                ])
              ])
            ]),
            _: 1
      ...
      _createVNode(_component_VCard, {
        ...
        default: _withCtx(() => [
          _createVNode(_component_VCardItem, { class: "sp-subheader" }, {
            prepend: _withCtx(() => [
              _createVNode(_component_VIcon, {
            ...
            default: _withCtx(() => [
              (identifierError.value)
                ? (_openBlock(), _createBlock(_component_VAlert, {
                    ...
                    class: "mb-3 text-caption",
                    closable: "",
                    "onClick:close": _cache[1] || (_cache[1] = $event => (identifierError.value = ''))
                  }, {
                    default: _withCtx(() => [
              ...
              (identifierMessage.value)
                ? (_openBlock(), _createBlock(_component_VAlert, {
                    ...
                    class: "mb-3 text-caption",
                    closable: "",
                    "onClick:close": _cache[2] || (_cache[2] = $event => (identifierMessage.value = ''))
                  }, {
                    default: _withCtx(() => [
                  ...
                  _createVNode(_component_VCol, {
                    ...
                    default: _withCtx(() => [
                      _createVNode(_component_VTextField, {
                        ...
                        "onUpdate:modelValue": _cache[3] || (_cache[3] = $event => ((identifierAutoTitle).value = $event)),
                        label: "媒体文件名",
                        density: "compact",
                        variant: "outlined",
                        "hide-details": "",
                  ...
                  _createVNode(_component_VCol, {
                    ...
                    default: _withCtx(() => [
                      _createVNode(_component_VTextField, {
                        ...
                        "onUpdate:modelValue": _cache[4] || (_cache[4] = $event => ((identifierManualTitle).value = $event)),
                        label: "媒体文件名",
                        density: "compact",
                        variant: "outlined",
                        "hide-details": "",
                  ...
                  _createVNode(_component_VCol, {
                    ...
                    default: _withCtx(() => [
                      _createVNode(_component_VSelect, {
                        ...
                        "onUpdate:modelValue": _cache[5] || (_cache[5] = $event => ((identifierManualType).value = $event)),
                  ...
                  _createVNode(_component_VCol, {
                    ...
                    default: _withCtx(() => [
                      _createVNode(_component_VTextField, {
                        ...
                        "onUpdate:modelValue": _cache[6] || (_cache[6] = $event => ((identifierManualTmdbid).value = $event)),
                        label: "TMDB ID",
              ...
              (identifierRecords.value.length)
                ...
                : (_openBlock(), _createElementBlock("div", _hoisted_16, "暂无识别词记录"))
            ]),
            _: 1
          })
        ]),
          ...
          _createVNode(_component_VCardText, { class: "pa-3" }, {
            default: _withCtx(() => [
              (ruleRecords.value.length)
                ...
                : (_openBlock(), _createElementBlock("div", _hoisted_17, "暂无记录"))
            ]),
            _: 1
          })
        ]),
          ...
          default: _withCtx(() => [
            ...
            _createVNode(_component_VCardText, { class: "pa-3" }, {
              default: _withCtx(() => [
                ...
                _createElementVNode("div", _hoisted_19, _toDisplayString(item.message), 1),
                          ...
                          _createElementVNode("tbody", null, [
                            (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(item.candidates.slice(0, 8), (candidate) => {
                              return (_openBlock(), _createElementBlock("tr", {
                                ...
                                _createElementVNode("td", _hoisted_21, _toDisplayString(candidate.site_name || candidate.site), 1),
                                _createElementVNode("td", _hoisted_22, _toDisplayString(candidate.title), 1),
                                _createElementVNode("td", _hoisted_23, _toDisplayString(candidate.seeders || 0), 1),
    ...
    _createVNode(_component_VFooter, { class: "sp-footer" }, {
      default: _withCtx(() => [
        _createVNode(_component_VContainer, { class: "d-flex align-center flex-wrap ga-1 pa-0" }, {
          default: _withCtx(() => [
            _createVNode(_component_VBtn, {
              color: "info",
            ...
            _createVNode(_component_VSpacer, { class: "sp-footer-spacer" }),
            _createVNode(_component_VBtn, {
              color: "primary",
              ...
              default: _withCtx(() => [
                ...
                (ruleSuggestions.value.length && !preview.value)
                  ? (_openBlock(), _createElementBlock("div", _hoisted_25, [
                      _cache[30] || (_cache[30] = _createElementVNode("div", { class: "text-caption text-medium-emphasis mb-2" }, "请选择要添加的官组、平台关键词或 PT 站点", -1)),
                ...
                (preview.value)
                  ? (_openBlock(), _createElementBlock("div", _hoisted_26, [
                      (preview.value.selected_text)
                        ? (_openBlock(), _createElementBlock("div", _hoisted_27, "已选择：" + _toDisplayString(preview.value.selected_text), 1))
                        : _createCommentVNode("", true),
...
const Page = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-decf9e21"]]);
