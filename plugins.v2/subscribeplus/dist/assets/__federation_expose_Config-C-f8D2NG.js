...
const _hoisted_48 = { class: "sp-section-title" };
const _hoisted_49 = { class: "sp-field-rows" };
const _hoisted_50 = { class: "sp-field-info" };
const _hoisted_51 = { class: "sp-field-label" };
const _hoisted_52 = {
  key: 0,
  class: "sp-field-hint"
};
...
const _hoisted_54 = { class: "sp-dashboard-section" };
const _hoisted_55 = { class: "sp-dashboard-title" };
const _hoisted_56 = { class: "sp-dashboard-row" };
const _hoisted_57 = { class: "sp-dashboard-row" };
const _hoisted_58 = { class: "sp-dashboard-row" };
const _hoisted_59 = { class: "sp-dashboard-row" };
const _hoisted_60 = { class: "sp-dashboard-section" };
const _hoisted_61 = { class: "sp-dashboard-title" };
const _hoisted_62 = { class: "sp-dashboard-row" };
                  ...
                  return _withDirectives(_createElementVNode("div", {
                    ...
                    (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(sectionsOf(groupKey), (section, sIdx) => {
                      return (_openBlock(), _createElementBlock("section", {
                        ...
                        _createElementVNode("div", _hoisted_48, _toDisplayString((sIdx + 1) + '. ' + section.title), 1),
                          ...
                          (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(section.fields, (field) => {
                            return (_openBlock(), _createElementBlock("div", {
                              ...
                              _createElementVNode("div", _hoisted_50, [
                                _createElementVNode("div", _hoisted_51, _toDisplayString(field.label), 1),
                                (field.hint)
                                  ? (_openBlock(), _createElementBlock("div", _hoisted_52, _toDisplayString(field.hint), 1))
                                  : _createCommentVNode("", true)
                              ]),
                ...
                (preview.value)
                  ? (_openBlock(), _createElementBlock("div", _hoisted_67, [
                      (preview.value.selected_text)
                        ? (_openBlock(), _createElementBlock("div", _hoisted_68, "已选择：" + _toDisplayString(preview.value.selected_text), 1))
                        : _createCommentVNode("", true),
...
const Config = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-4c77bbc7"]]);
