...
const _hoisted_3 = { class: "summary-grid mb-4" };
const _hoisted_4 = { class: "summary-panel accent-red" };
const _hoisted_5 = { class: "summary-panel accent-green" };
const _hoisted_6 = { class: "summary-panel accent-blue" };
const _hoisted_7 = { class: "path-line" };
      ...
      default: _withCtx(() => [
        ...
        _createElementVNode("div", _hoisted_3, [
          _createElementVNode("div", _hoisted_4, [
            _cache[4] || (_cache[4] = _createElementVNode("span", null, "无效记录", -1)),
            _createElementVNode("strong", null, _toDisplayString(invalidItems.value.length), 1)
          ]),
          _createElementVNode("div", _hoisted_5, [
            _cache[5] || (_cache[5] = _createElementVNode("span", null, "本地源可用", -1)),
            _createElementVNode("strong", null, _toDisplayString(localSourceCount.value), 1)
          ]),
          _createElementVNode("div", _hoisted_6, [
            _cache[6] || (_cache[6] = _createElementVNode("span", null, "运行目录存在", -1)),
              ...
              default: _withCtx(() => [
                (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(invalidItems.value, (plugin) => {
                  return (_openBlock(), _createBlock(_component_v_list_item, {
                    ...
                    default: _withCtx(() => [
                      _createElementVNode("div", _hoisted_7, _toDisplayString(plugin.runtime_path), 1)
                    ]),
                    _: 2
                  }, 1032, ["title", "subtitle"]))
                }), 128))
...
const Page = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-7eea1e8d"]]);
